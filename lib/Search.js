...
class Search extends Requestable {
    ...
    * @param {Number} [maxPages] - the maximum number of pages to return if the query spans multiple pages
    * @return {Promise} - the promise for the http request
    */
   _search(path, withOptions = {}, cb = undefined, maxPages = undefined) {
      let requestOptions = {};
      ...
      return this._requestAllPages(`/search/${path}`, requestOptions, cb, undefined, maxPages, 1);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   forRepositories(options, cb, maxPages) {
      if (typeof cb === 'number') {
         maxPages = cb;
         cb = undefined;
      }
      return this._search('repositories', options, cb, maxPages);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   forCode(options, cb, maxPages) {
      if (typeof cb === 'number') {
         maxPages = cb;
         cb = undefined;
      }
      return this._search('code', options, cb, maxPages);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   forIssues(options, cb, maxPages) {
      if (typeof cb === 'number') {
         maxPages = cb;
         cb = undefined;
      }
      return this._search('issues', options, cb, maxPages);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   forUsers(options, cb, maxPages) {
      if (typeof cb === 'number') {
         maxPages = cb;
         cb = undefined;
      }
      return this._search('users', options, cb, maxPages);
   }
}
